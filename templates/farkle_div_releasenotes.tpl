...
<div id="divReleaseNotes" class="pagelayout" align="center" style="display: none;">
	...
	<div class="loginBox" style="text-align: left; max-width: 500px; padding: 15px;">
		<h2 style="text-align: center; margin-top: 5px; margin-bottom: 15px;">Release Notes</h2>

		{if isset($release_notes.releases)}
			{foreach $release_notes.releases as $release}
				<div style="margin-bottom: 20px;">
					<div style="color: #FFCC66; font-size: 14pt; font-weight: bold;">
						v{$release.version}
					</div>
					<div style="font-size: 10pt; color: #ccc; margin-bottom: 5px;">

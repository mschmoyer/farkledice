...
*/
var gAjaxUrl = 'wwwroot/farkle_fetch.php';
...
function DisplayPlayerTag( appendDivId, pData, score ) //thePlayerId, name, color, score, title, fbid, allowDupes )
{
	...
	if( pData.facebookid ) {
		var fbImage = 'https://graph.facebook.com/' + pData.facebookid + '/picture';
		n.find('#playerImg').show().attr('src', fbImage).addClass('playerCardImage');
	}
 	else {
